...
Généré le : `2026-05-15T19:04:45`

## 1. Verdict

Le repo est techniquement exploitable, mais 119 bloc(s) YAML ne sont pas classés.
La dette principale reste la migration v2 : 1564 atome(s) incomplet(s) sur 1625.

## 2. Synthèse chiffrée

- Enregistrements : 3391
- Erreurs : 0
- Avertissements : 16542
...
| invalid_controlled_value | 1353 |
| missing_required_field | 4800 |
| schema_warning | 399 |
| unknown_yaml_block | 119 |
| v2_migration_debt | 9736 |
...
- … 79 bloc(s) supplémentaire(s) dans `audit_repo.json`.
...
- Atomes v2 incomplets : 1564
- Avertissements de champs v2 manquants : 9736
