...
Le repo est techniquement exploitable, mais 1508 bloc(s) YAML ne sont pas classés.
...
| missing_required_field | 10099 |
| schema_warning | 492 |
| unknown_yaml_block | 1508 |
...
- … 1468 bloc(s) supplémentaire(s) dans `audit_repo.json`.
