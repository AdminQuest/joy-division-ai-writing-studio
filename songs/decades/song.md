...
Ce dossier rassemble les informations documentaires relatives au titre canonique « Decades » : paroles, variantes, sessions, sorties, concerts, bootlegs, sources et atomes liés.
...
```text
songs/decades/song.md
songs/decades/lyrics.md
songs/decades/sessions.md
songs/decades/live_occurrences.md
songs/decades/releases.md
songs/decades/bootlegs.md
