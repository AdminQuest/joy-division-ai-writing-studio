...
> Régénéré le **06 juin 2026** depuis `data/registre.json`, `exports/generated/audit_repo.json` et `registers/`.  
...
| Dette migration v2 (atomes incomplets) | 2 530 / 2 769 |
...
- **Dette migration v2** : 2 530 atomes sur 2 769 manquent de champs v2 obligatoires. Cette dette ne doit pas être corrigée mécaniquement — elle relève d'une migration progressive source par source.
- **REGISTRY** : identifiant interne de référence pour les chansons, ajouté au registre le 26/05/2026.

---

_Tableau régénéré le 06 juin 2026 — état complet post-audit. 0 erreur bloquante. Citations H&S S85–S88 vérifiées sur PDF._

_Synchronisation automatique morning_sync — 2026-06-06_