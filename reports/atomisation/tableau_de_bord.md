...
> Régénéré le **2 juin 2026** depuis `data/registre.json`, `exports/generated/audit_repo.json` et `registers/`.  
> État vérifié : 0 erreur bloquante · 2 770 atomes · 8 433 enregistrements · 97 sources déclarées.
...
| Total enregistrements (toutes types) | **8 433** |
...
| **Total** | **97** (+ REGISTRY, REGISTRY-CONCERTS, REGISTRY-SESSIONS) |
...
| S93 | Parker | Simon Reynolds, Retromania and the Atemporality of Contemporary Pop | 📌 Fixée | — | — | 11 | 0 | 0 | 0 | 0 | 🔵 Partielle (pag. NR) |
| S94 | Weissinger | Retromania: Pop Culture's Addiction to Its Own Past (Book Review) | 📌 Fixée | — | — | 7 | 0 | 0 | 0 | 0 | 🔵 Partielle (pag. NR) |
...
| v2 migration debt | 2 530 atomes | non démarrée (stratégique) |
...
_Tableau régénéré le 2 juin 2026 — état complet post-audit. 0 erreur bloquante. Citations H&S S85–S88 vérifiées sur PDF._

_Synchronisation automatique morning_sync — 2026-06-02_
