...
statut: "source canonique corrigee et fixee"
...
## 5. Decision canonique

S40 designe exclusivement l'article de Fortunato M. Cacciatore intitule « ...waiting for something to happen... », publie dans le volume collectif dirige par Alfonso Amendola et Linda Barone, *Our Vision Touched the Sky: Fenomenologia dei Joy Division*, Roma, Rogas Edizioni, 2021.

S40 ne designe pas le volume collectif complet. Le volume est seulement le contenant bibliographique. Les autres contributions du volume doivent conserver ou recevoir leurs propres identifiants lorsqu'elles sont atomisees separement.

## 6. Fonction dans le livre

S40 sert a penser les dimensions philosophiques, temporelles et hauntologiques de Joy Division : attente, futur perdu, spectres, impossibilite d'un avenir stabilise, rapport entre post-punk, no future, modernite tardive et critique musicale.

La source peut nourrir les chapitres consacres a la temporalite, a la posterite, au statut spectral de Joy Division, a la critique de l'historicisme imaginatif et a la reception contemporaine du groupe.

## 7. Entree canonique pour `data/registre.json`
...
```json
{
  ...
  "arbitrage": "S40 ne reference que l'article de Fortunato M. Cacciatore, « ...waiting for something to happen... ». L'ancienne entree centree sur une formule generale de nostalgie du futur doit etre resserree autour de l'article, de son auteur, de son volume contenant et de sa fonction philosophique. Le volume collectif complet ne doit pas etre pris comme objet canonique S40.",
  "prudence": "Ne pas confondre S40 avec le volume complet dirige par Amendola et Barone. Ne pas confondre S40 avec S13, qui concerne l'article de Caterina Tomeo dans le meme volume. Verrouiller la pagination avant toute citation directe. Distinguer les references philosophiques mobilisees par Cacciatore de faits historiques sur Joy Division."
}
```
