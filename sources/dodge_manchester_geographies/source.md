# S20 — Martin Dodge, *Manchester Geographies*, chapitre 3
...
statut: "source canonique ; année et édition à confirmer"
...
fichier_source_recommande: "S20_dodge_manchester_geographies_housing_problems.pdf"
...
La source Dodge est désormais intégrée sous l’identifiant **S20**.

Arbitrage retenu : l’ancien S20, consacré à Simon Reynolds, *Rip It Up and Start Again*, est considéré comme un doublon de S72 et doit être redirigé vers S72. S20 est donc libéré et réattribué à Martin Dodge.

La demande initiale mentionnait S04. S04 reste conservé pour Alan J. Kidd, *Manchester: A History*, 2006. Il ne doit pas être écrasé.
...
1. Ne pas écraser S04 : S04 est Alan J. Kidd, *Manchester: A History*, 2006.
2. Ne pas réutiliser l’ancien S20 Reynolds : cet ancien S20 doit être redirigé vers S72.
3. Ne pas traiter Dodge comme Kidd : Dodge est une source géographique et cartographique sur le logement, non une histoire générale de Manchester.
4. Ne pas confondre *Manchester Geographies* avec *Manchester: A History*.
5. Ne pas utiliser cette source comme source directe sur Joy Division.
6. Ne pas réduire Manchester au seul motif des taudis victoriens : Dodge suit une séquence longue, du XIXe siècle aux politiques de logement du XXe siècle et aux transformations contemporaines.
7. Ne pas confondre Hulme, Wythenshawe, Hattersley, Beswick, Moss Side, Angel Meadow et Little Ireland.
8. Ne pas utiliser les cartes comme simples illustrations atmosphériques : elles servent à spatialiser des politiques de logement, des diagnostics sociaux et des choix de planification.
9. Vérifier l’année et l’édition de *Manchester Geographies* avant citation bibliographique finale.
