...
> registre chronologique. Vocabulaire **fermé** à quatre valeurs. Additif,
...
| `concert_a_migrer` | Concert **ordinaire** du groupe (gig de tournée sans portée de jalon), ou gig dont la seule singularité est une remarque accolée. | Conservé, ID legacy gardé, **non** promu en `EVENT-`. Migrera vers le registre `CONCERT-` (étape 10), où la date redevient un attribut. |
