# Chapitre 7 — L'héritage musical à travers les décennies
...
Cartographier les héritages musicaux et les reprises esthétiques de Joy Division.

## 2. Questions directrices

- Quels héritages sont musicaux plutôt que seulement visuels ?
- Quels prolongements relèvent d’une influence documentée ?
...
- **S50-A002** — S50-A002 — *Unknown Pleasures Reimagined* : dix vidéos pour quarante ans de culte  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `evenement_mediatique` ; importance : `critique` ; preuve : `fait_documente_par_s50`.
- **S50-A011** — S50-A011 — Traduction intersémiotique : conditions d’une réinvention réussie  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `concept_critique_central`.
- **S50-A014** — S50-A014 — « Insight » par Makoto Nagahisa : le meilleur cas d’expansion de sens  
...
- acid house (2)
- rave era (2)
- marges industrielles (1)
- périphéries du Nord (1)
- déplacement vers le centre (1)
- sortie du punk (1)
- reconstruction (1)
- expérimentation (1)
...
- Factory (1)
- institution esthétique (1)
- exportation de la périphérie (1)
- rhizome (1)
- dispersion des scènes (1)
- expérimentation électronique (1)
- passage au mainstream (1)
- réification (1)
...
- S35-A066 — prolonge → S35-A051
- S35-A072 — nuance → MYTHE-S35-001
- S35-A072 — prolonge → S35-A054
- S35-A074 — prolonge → S35-A071
- S35-A075 — prolonge → S35-A054
- S35-A075 — nuance → S35-A074
- S35-A095 — prolonge → S35-A069
- S35-A095 — prepare → S41-A052
