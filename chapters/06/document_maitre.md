# Chapitre 6 — L’arbre se dresse : quand l’architecture sonore devient cathédrale (1979-1980)
...
Montrer comment la production, l’espace sonore et la forme-album transforment Joy Division en cathédrale noire.

## 2. Questions directrices

- Comment le groupe devient-il architecture sonore ?
- Comment traiter *Closer* sans téléologie morbide ?
...
| S72 | S72 — Reynolds, Rip It Up and Start Again, 2005/2006 | 5 | 0 |
...
| S79 | S79 — Curtis, So This Is Permanence, 2014 | 35 | 0 |
| S80 | S80 — Valdés Miyares, Communication Breakdown / Transmission, 2018 | 7 | 0 |
| S82 | S82 — Parmar, Joy Division in Space / Aesthetics of Estrangement, 2018 | 7 | 0 |
| S83 | S83 — Greenwood & Tarpey, Manchester, Hannett and Joy Division's Pungent Architecture, 2018 | 2 | 0 |
| S84 | S84 — Cope, Moving Image Record of Joy Division and Factory Video Unit, 2018 | 8 | 1 |
...
- **S37-A067** — S37-A067 — Sections LI-LIII : « Listen to the Silence » (1997) — Joy Division comme Elvis de Morley pour les ténèbres  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `analyse_critique` ; importance : `critique` ; preuve : `texte_1997_retrospectif`.
...
- **S41-A021** — S41-A021 — Dernier concert Pistols : violence de masse et fin de l’innocence punk  
  Source : S41 — Hook, Unknown Pleasures, 2012 ; type : `scene_live_violence` ; importance : `critique` ; preuve : `témoignage direct rétrospectif`.
...
- **S41-A026** — S41-A026 — De Stiff Kittens à Warsaw : austérité nominale, Low et premier malentendu graphique  
  Source : S41 — Hook, Unknown Pleasures, 2012 ; type : `construction_esthetique` ; importance : `critique` ; preuve : `témoignage direct rétrospectif`.
- **S41-A027** — S41-A027 — Premier concert Warsaw : ignorance technique et foi anti-careeriste  
  Source : S41 — Hook, Unknown Pleasures, 2012 ; type : `scene_live` ; importance : `critique` ; preuve : `témoignage direct + chronologie établie`.
...
- **S41-A036** — S41-A036 — Rob Gretton avant Rob : scène Panik, Slaughter et faveur involontaire  
...
- **S41-A089** — S41-A089 — Locarno Bristol : éviction de tournée, Chelsea et violence Manc/Cockney  
  Source : S41 — Hook, Unknown Pleasures, 2012 ; type : `scene_tournee_conflit` ; importance : `critique` ; preuve : `témoignage direct`.
...
- **S37-A068** — S37-A068 — Section LIV : « Because » — liste analytique-poétique des raisons de la signification de Joy Division  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `texte_poetique_analytique` ; importance : `haute` ; preuve : `texte_poétique_analytique`.
- **S37-A070** — S37-A070 — Section LVIII : Essai Peter Saville (Frieze, 2003) — Unknown Pleasures comme « visual sound »  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `analyse_critique` ; importance : `haute` ; preuve : `texte_2003`.
...
- **S41-A017** — S41-A017 — Punk look : Oxfam, Scout shop et leper treatment  
...
- **S41-A029** — S41-A029 — Newcastle et sleeping bag : micro-sociologie du groupe en tournée pauvre  
...
- **S41-A035** — S41-A035 — Terry et les cassettes : management amateur, Coronation Street et ratage promotionnel  
...
- **S76-Q156** — S76 — Middles & Reade, Torn Apart, 2006 — statut : `candidate` — «  »
- **S76-Q158** — S76 — Middles & Reade, Torn Apart, 2006 — statut : `candidate` — «  »
- **S76-Q160** — S76 — Middles & Reade, Torn Apart, 2006 — statut : `candidate` — «  »
...
| PERS-S31-008 | Peter Saville | Graphiste intégré à l’impresa comune et à l’identité visuelle Factory / Joy Division. |
...
| PERS-S60-002 | Peter Saville | Graphiste de la pochette d’Unknown Pleasures ; référence à croiser avec S48 pour la genèse graphique. |
...
| PERS-S58-003 | Bernard Sumner | Témoin et acteur de la continuité Joy Division / New Order ; cité en exergue du chapitre. |
| PERS-S58-006 | Martin Hannett | Producteur considéré comme médiateur technique vers l’électronique et le studio-instrument. |
...
| PERS-S59-003 | Peter Hook | Témoin mobilisable sur l’anti-image et la distance publique de Joy Division. |
| PERS-S59-004 | Peter Saville | Graphiste de Factory et d’Unknown Pleasures ; opérateur de retrait visuel et d’anonymat graphique. |
...
| PERS-S76-045 | Alan Erasmus | ["acteur", "cofondateur du dispositif Factory avec Tony Wilson", "promoteur initial au Russell Club"] |
...
| PERS-S76-035 | Bob Auger | ["ingénieur / acteur technique des sessions Arrow selon S76"] |
...
- S57-A003 — fonde → CONCEPT-permanence_instable_still
...
| discographie_posthume | 1 |
| concept_discographique | 1 |
| note_documentaire | 1 |
| evenement_crise | 1 |
