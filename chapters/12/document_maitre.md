...
- **S37-A057** — S37-A057 — Section XXX : Morley rédige l'obituaire de Curtis, parallèle avec le suicide de son père  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `temoignage_autobiographique` ; importance : `haute` ; preuve : `retrospective_autobiographique`.
- **S37-A059** — S37-A059 — Section XXXIII : Tony Wilson montre à Morley le corps de Curtis  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `temoignage_autobiographique` ; importance : `haute` ; preuve : `retrospective_forte_Wilson_confirme_dans_LXI`.
- **S37-A060** — S37-A060 — Section XXXIV : Extrait de *Nothing* (Faber, 2000) — le cadavre  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `texte_litteraire` ; importance : `moyenne` ; preuve : `texte_litteraire_2000`.
- **S37-A073** — S37-A073 — Section LXIV : Observer Music Monthly sept. 2007 — Control (Corbijn), Stephen Morris, Anton Corbijn  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `reportage_contemporain` ; importance : `haute` ; preuve : `forte_texte_contemporain_2007`.
