# Chapitre 5 — La troisième racine : Peter Saville et l'esthétique du vide
...
- **S47-044** — S47-044 — Factory fonctionne sans contrat traditionnel  
  Source : S47 — West, Joy Division, 1984 ; type : `sociologie` ; importance : `critique` ; preuve : `fait_documente`.
- **S47-055** — S47-055 — Les ventes d’*Unknown Pleasures* et le plafond Factory  
...
- **S50-A001** — S50-A001 — S50 comme source sur la réimagination audiovisuelle contemporaine  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `prudence_methodologique` ; importance : `critique` ; preuve : `cadrage_methodologique`.
- **S50-A005** — S50-A005 — L’imaginaire collectif comme co-création médiatique  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `cadre_theorique_secondaire`.
- **S50-A007** — S50-A007 — Saville, Cummins, Corbijn : textes canoniques de l’imaginaire visuel  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `canon_visuel` ; importance : `critique` ; preuve : `synthese_iconographique`.
- **S51-A001** — S51-A001 — S51 comme source sur l’image lo-fi, non sur le fait brut  
  Source : S51 — Malvezzi, Dream English Kid 1978-1980, 2021 ; type : `prudence_methodologique` ; importance : `critique` ; preuve : `cadrage_methodologique`.
- **S51-A006** — S51-A006 — Image pauvre : Steyerl, perte de consistance et vitesse de circulation  
  Source : S51 — Malvezzi, Dream English Kid 1978-1980, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `concept_critique_central`.
- **S51-A007** — S51-A007 — Images pauvres à la troisième puissance  
  Source : S51 — Malvezzi, Dream English Kid 1978-1980, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `synthese_critique`.
- **S51-A011** — S51-A011 — L’image lo-fi contre l’image canonique  
...
- **S29-A006** — S29-A006 — Ruines du modernisme : postindustrial cityscapes, Ballard, Kafka, Burroughs, Gogol  
  Source : S29 — Goddard, Missions of Dead Souls, 2018 ; type : `modernisme_litteraire` ; importance : `non qualifiée` ; preuve : `forte`.
...
- **S37-A074** — S37-A074 — Section LXV : « Last lines » collectées 1987-2007 — fragments et datations finales  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `fragments_editoriaux` ; importance : `haute` ; preuve : `fragments_varies`.
