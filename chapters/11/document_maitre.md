# Chapitre 11 — Joy Division et la condition humaine moderne
...
Interroger la persistance existentielle de Joy Division dans la condition humaine moderne.

## 2. Questions directrices

- Pourquoi Joy Division parle-t-il encore à la condition moderne ?
- Comment éviter les généralités existentielles ?
...
- **S40-A005** — S40-A005 — L’attente sans horizon stable : structure temporelle du titre  
  Source : S40 — Cacciatore, ...waiting for something to happen..., 2021 ; type : `motif_majeur` ; importance : `critique` ; preuve : `lecture critique du passage`.
...
- **S41-A050** — S41-A050 — Controverse nazie : accumulation de signes, défense naïve et contretemps politique  
...
- **S49-A015** — S49-A015 — Mélancolie masculine : forteresse, perte et narcissisme  
  Source : S49 — Farci, Here are the Young Men, the weight on their shoulders, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `lecture_theorique_secondaire`.
- **S49-A017** — S49-A017 — *There’s No Turning Back* : le rock dépouillé de ses illusions  
  Source : S49 — Farci, Here are the Young Men, the weight on their shoulders, 2021 ; type : `synthese_argumentative` ; importance : `critique` ; preuve : `synthese_critique`.
- **S54-A001** — S54-A001 — S54 comme source intertextuelle, non comme preuve primaire des lectures de Curtis  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `prudence_methodologique` ; importance : `critique` ; preuve : `cadrage_methodologique`.
- **S54-A004** — S54-A004 — « Digital » et Burroughs : clôture, chaleur et logique binaire  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `lecture_chanson` ; importance : `critique` ; preuve : `hypothese_intertextuelle`.
- **S54-A006** — S54-A006 — « Interzone » : titre burroughsien, espace de passage et zone psychique instable  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `concept_intertextuel`.
- **S54-A007** — S54-A007 — Ballard, *Crash* et « Exercise One » : cicatrices, voiture, technologie et désir  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `lecture_chanson` ; importance : `critique` ; preuve : `hypothese_intertextuelle_forte`.
- **S54-A008** — S54-A008 — « Atrocity Exhibition » : violence, médias et exposition intérieure du désastre  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `lecture_chanson` ; importance : `critique` ; preuve : `intertextualite_titulaire_et_thematique`.
- **S54-A009** — S54-A009 — Dystopie intérieure : les pathologies sociales traduites dans le sujet  
  Source : S54 — Gnocchi, Interzona. Burroughs e Ballard nei testi di Ian Curtis, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `concept_critique_central`.
...
- **S39-A004** — S39-A004 — Fragilité des liens sociaux et précarité des appartenances  
  Source : S39 — Bauman, Liquid Modernity, 2000 ; type : `motif_majeur` ; importance : `majeure` ; preuve : `source secondaire théorique`.
- **S40-A004** — S40-A004 — La lente cancellazione del futuro : diagnostic et risque de clôture  
  Source : S40 — Cacciatore, ...waiting for something to happen..., 2021 ; type : `concept_critique` ; importance : `majeure` ; preuve : `source secondaire critique`.
