# Chapitre 4 — La deuxième racine : la poésie de l’aliénation de Ian Curtis
...
Étudier l’écriture de Curtis comme poésie de l’aliénation, sans rabattre les textes sur une lecture strictement biographique.

## 2. Questions directrices

- Comment lire Curtis sans réduire les chansons à sa biographie ?
- Quels textes relèvent de l’aliénation, du contrôle, de la crise ?
...
- **S37-A050** — S37-A050 — NME record review A Factory Sampler, 31 mars 1979 : Joy Division et Digital/Glass  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `recension_contemporaine` ; importance : `critique` ; preuve : `forte_texte_contemporain`.
- **S37-A051** — S37-A051 — Section XXI et XXII : Première interview NME de Joy Division (janvier 1979) et première couverture Ian Curtis  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `temoignage_contemporain` ; importance : `critique` ; preuve : `forte_NME_1979 ; moyenne_retrospective_Morley_2008`.
...
- **S49-A001** — S49-A001 — Le post-punk comme déconstruction de l’idéal viril rock  
  Source : S49 — Farci, Here are the Young Men, the weight on their shoulders, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `source_secondaire_critique`.
...
- **S50-A008** — S50-A008 — VHS, télévision musicale et apparition du corps de Curtis  
  Source : S50 — Bertetti & Morreale, Reimmaginare l’immaginario, 2021 ; type : `mediation_audiovisuelle` ; importance : `critique` ; preuve : `synthese_audiovisuelle_a_verifier`.
...
- **S52-A001** — S52-A001 — S52 comme source critique sur *Control*, non comme source primaire biographique  
  Source : S52 — Rabbito, Control e l’infrangimento del vetro, 2021 ; type : `prudence_methodologique` ; importance : `critique` ; preuve : `cadrage_methodologique`.
- **S52-A004** — S52-A004 — Le défaut central : rester à la surface biographique  
  Source : S52 — Rabbito, Control e l’infrangimento del vetro, 2021 ; type : `concept_structurant` ; importance : `critique` ; preuve : `concept_critique_central`.
- **S52-A006** — S52-A006 — Deborah Curtis comme source structurante et limite  
  Source : S52 — Rabbito, Control e l’infrangimento del vetro, 2021 ; type : `source_interne` ; importance : `critique` ; preuve : `source_primaire_retroactive_mobilisee_par_s52`.
- **S52-A008** — S52-A008 — *Control* fabrique un Curtis monodimensionnel  
  Source : S52 — Rabbito, Control e l’infrangimento del vetro, 2021 ; type : `critique_filmique` ; importance : `critique` ; preuve : `critique_de_representation`.
...
- **S10-PART-SUMNER-SALFORD-FORMATION-SOUND-V2** — S10 — Passe v2 — Sumner, Salford, formation et son Joy Division  
  Source : S10 — Sumner, Chapter and Verse, 2014/2015 ; type : `source_part` ; importance : `non qualifiée` ; preuve : `forte, mais témoignage rétrospectif à croiser`.
- **S37-A049** — S37-A049 — Section XVII-XIX : Factory Records fondation, Alan Erasmus, Factory Sampler preview NME (2 décembre 1978)  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `analyse_historique` ; importance : `haute` ; preuve : `forte_pour_texte_NME_1978 ; moyenne_retrospective_Erasmus`.
- **S37-A061** — S37-A061 — Section XXXV : Rob Gretton — « We've all got our idiosyncrasies »  
  Source : S37 — Morley, Joy Division: Piece by Piece, 2008 ; type : `temoignage_retrospectif` ; importance : `moyenne` ; preuve : `moderee_retrospective_1991`.
...
- **S47-053** — S47-053 — Curtis : entre Jim Morrison et Iggy Pop dans la réception critique  
  Source : S47 — West, Joy Division, 1984 ; type : `reception` ; importance : `majeure` ; preuve : `interpretation_critique`.
...
- **S47-188** — S47-188 — Citation critique : Curtis comme « loser caught in a world only partially understood »  
  Source : S47 — West, Joy Division, 1984 ; type : `citation_clef` ; importance : `modérée` ; preuve : `fragment_textuel`.
...
| PERS-S76-005 | Barbara Lloyd / Aunt Barbara | ["tante de Ian Curtis", "témoin familial"] |
| PERS-S76-006 | Pete Johnson | ["ami d'enfance de Ian Curtis", "témoin scolaire et adolescent"] |
| PERS-S76-007 | Tony Nuttall | ["ami d'enfance de Ian Curtis", "compagnon de speedway et de sociabilité locale"] |
| PERS-S76-008 | Paul Heapy | ["ami scolaire de Ian Curtis et Pete Johnson"] |
...
| PERS-S76-015 | Kelvin Briggs | ["ami de King’s School", "témoin du cercle adolescent", "témoin / best man au mariage de Curtis"] |
...
- solitude (2)
- paternité (2)
- lacune_documentaire_paroles_curtis (2)
- échec (2)
- modernité (2)
- force (2)
- premier âge (2)
...
- S56-A014 — fonde → S56-A015
- S56-A014 — fonde → S56-A016
